...
$$X_1$$과 $$X_3$$은 부모 Node가 없기 때문에 단독으로 분포를 쓸 수 있고 ($$P(X_1), P(X_3)$$), $$X_2$$의 부모 Node는 $$X_1$$, $$X_4$$의 부모 Node는 $$X_2, X_3$$이므로 $$P(X_2 \vert X_1)$$, $$P(X_4 \vert X_2, X_3)$$로 쓴 것을 확인할 수 있다.
