...
그 다음 결과는 이전 TTS 모델들과의 MOS 스코어의 비교이다. MOS 스코어는 음성 합성의 특성상 많이 사용되는 지표이다. 크라우드 소싱을 통하여 얼마나 사람에 가까운지를 1에서 5점 사에로 매겨서 구하는 점수이다. 여기서 Concatenative 보다는 성능이 떨어지지만 Parametric은 상회하는 성능을 보인다는 것을 확인할 수 있다.

![](/assets/img/2018-12-11-tacotron/08.png)

Tacotron의 음성 샘플은 [링크](https://google.github.io/tacotron/)에서 확인할 수 있다.
