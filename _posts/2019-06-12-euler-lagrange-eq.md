...
& = \int_{t_1}^{t_2} \frac{\partial L}{\partial \mathbf{q}} \cdot \mathbf{u}(t) + \left(\frac{d}{dt} \frac{\partial L}{\partial \right) \dot{\mathbf{q}}} \cdot \mathbf{u}(t) dt + \epsilon \left[ \frac{\partial L}{\partial \dot{\mathbf{q}}} \cdot \mathbf{u}(t) \right]_{t=t_1}^{t=t_2}
\end{align*}
$$
